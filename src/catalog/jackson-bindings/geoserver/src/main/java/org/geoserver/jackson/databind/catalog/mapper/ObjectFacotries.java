...
public class ObjectFacotries {
    ...
    public @ObjectFactory DataLinkInfo dataLinkInfo(DataLinkInfoDto source) {
        DataLinkInfoImpl dataLinkInfoImpl = new DataLinkInfoImpl();
        dataLinkInfoImpl.setId(source.getId());
        return dataLinkInfoImpl;
    }

    public @ObjectFactory AttributionInfo attributionInfo(AttributionInfoDto source) {
        AttributionInfoImpl attributionInfoImpl = new AttributionInfoImpl();
        attributionInfoImpl.setId(source.getId());
        return attributionInfoImpl;
    }
