...
import org.geoserver.cloud.event.remote.datadir.EventualConsistencyEnforcer;
import org.geoserver.cloud.event.remote.datadir.EventuallyConsistentCatalogFacade;
...
public class DataDirectoryBackendConfiguration extends GeoServerBackendConfigurer {
    ...
    protected @Bean @Override ExtendedCatalogFacade catalogFacade() {
        ...
        return new EventuallyConsistentCatalogFacade(memory, tracker);
    }
